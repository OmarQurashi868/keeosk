...
* `/resend-category` — Delete the existing panel message and resend it
  * `name` — category to resend
  * `channel` *(optional)* — send to a different channel; useful for reordering panels
